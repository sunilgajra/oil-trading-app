/**
 * Main Entry Point - Murji Oil Dashboard (Root Version)
 */
import { supabaseClient, updateAuthStateUI, handleLogin, handleLogout } from './js/core/auth.js';
import { state, config, validateState, saveState, DEF_S } from './js/core/state.js';
import { initializeStorage } from './js/core/storage.js';
import { updateClock, toast, showImage } from './js/utils/dom.js';
import { renderTradesTable, populateTradeParties, initTradeForm, renderTradeDocs, removeTradeDoc, addExpenseRow } from './js/ui/trades.js';
import { renderYardDashboard, renderInventoryTable } from './js/ui/inventory.js';
import { renderDashboardKpis, renderTicker } from './js/ui/dashboard.js';
import { refineWithCloudAI } from './js/services/ai.js';
...
async function init() {
    console.log("Initializing Murji Oil ERP (Root)...");
